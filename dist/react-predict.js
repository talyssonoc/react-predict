(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['react', 'jst9', 'classnames', 'react-onclickoutside'], function(React, jsT9, classNames, OnClickOutside) {
    	return (root.Predict = factory(React, jsT9, classNames, OnClickOutside));
    });
  } else if (typeof exports === 'object') {
    module.exports = factory(require('react'), require('jst9'), require('classnames'), require('react-onclickoutside'));
  } else {
    root.Predict = factory(root.React, root.jsT9, root.classNames, root.OnClickOutside);
  }
...
var Predict = React.createClass({displayName: "Predict",
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "react-predict"}, 
